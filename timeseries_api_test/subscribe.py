...
if __name__ == '__main__':
    ...
    # alarms_topic = topics.service_output_topic('gridappsd-alarms', simulation_id)
    # gapps.subscribe(alarms_topic, Subscribe.on_message)

    #For testing the  Logging API uncomment the below line
    #gapps.subscribe(simulation_log_topic(simulation_id),Subscribe.on_message)
